...
/root/coredns/coredns-svc.yaml:
  file:
    - managed
    - source: salt://pods/coredns/coredns-svc.yaml
    - user: root
    - group: root
    - mode: 755

/root/coredns/coredns-rc.yaml:
  file:
    - managed
    - source: salt://pods/coredns/coredns-rc.yaml
    - user: root
    - group: root
    - mode: 755
...
coredns-service:
  cmd.run:
    - name: kubectl create -f /root/coredns/coredns-svc.yaml

coredns-rc:
  cmd.run:
    - name: kubectl create -f /root/coredns/coredns-rc.yaml
